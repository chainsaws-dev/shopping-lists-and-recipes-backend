...
HeaderComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: HeaderComponent, selectors: [["app-header"]], decls: 1, vars: 1, consts: [["class", "navbar navbar-expand-lg navbar-light bg-light", "style", "background-color: #e3f2fd;", 4, "ngIf"], [1, "navbar", "navbar-expand-lg", "navbar-light", "bg-light", 2, "background-color", "#e3f2fd"], [1, "container-fluid"], [1, "navbar-header"], ["href", "#", 1, "navbar-brand"], [1, "navbar-expand", "mr-auto", "mt-2", "mt-lg-0"], [1, "nav", "nav-tabs"], [1, "nav-item"], ["routerLink", "/recipes", "routerLinkActive", "active", 1, "nav-link"], ["routerLink", "/shopping-list", "routerLinkActive", "active", "class", "nav-link", 4, "ngIf"], ["routerLink", "/admin", "routerLinkActive", "active", "class", "nav-link", 4, "ngIf"], [1, "form-inline", 3, "ngSubmit"], ["searchform", "ngForm"], ["placement", "bottom", "ngbTooltip", "View profile", "type", "button", "routerLinkActive", "active", "routerLink", "/profile", 1, "btn", "btn-outline-secondary", "mr-sm-2", "my-2", "my-sm-0"], ["type", "button", 1, "btn", "btn-outline-primary", "mr-sm-2", "my-2", "my-sm-0", 3, "click"], ["type", "search", "placeholder", "Search", "ngModel", "", "name", "searchreq", "required", "", 1, "form-control", "mr-sm-2"], ["type", "submit", 1, "btn", "btn-outline-primary", "my-2", "my-sm-0", 3, "disabled"], ["routerLink", "/shopping-list", "routerLinkActive", "active", 1, "nav-link"], ["routerLink", "/admin", "routerLinkActive", "active", 1, "nav-link"]], template: function HeaderComponent_Template(rf, ctx) { if (rf & 1) {
